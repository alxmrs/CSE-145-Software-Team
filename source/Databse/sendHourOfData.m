% script to test sending an hour of data

addpath('/Users/Xander/Documents/MATLAB/encoder/encoder');
...
x = 1:(60*250); y = sin(2*pi*x*13);
dataset = repmat(y, 8, 1) ; %+ rand(8,60*250)*.2; % rand(8, 250*60); 
